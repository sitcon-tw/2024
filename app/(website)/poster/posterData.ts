export default [
  {
    title: "我預判你的預判：中學生與 AI 圍棋理論的對戰歷程",
    author: "tudo",
    authorDescription:
...
GitHub: [https://github.com/jwliao1209](https://github.com/jwliao1209)`,
    description:
      "在本專案中，我們想建立 AI tutor 回答高中生社會科的問題。我們整理近 30 年的學測社會科考題與社會科題庫，利用 instruction tuning fine tune TAIWAN-LLM-7B 模型，並採用 LoftQ、Lion Optimizer 等方法提升模型效能，最後比較模型於社會三科中的表現。我們的專案公開至 [https://github.com/jwliao1209/TWLLM-Tutor](https://github.com/jwliao1209/TWLLM-Tutor)。",
    tags: [`LLM`, `NLP`, `AI`],
