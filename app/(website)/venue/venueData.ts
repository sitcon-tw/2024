export default {
  ...
  3: [
    ...
    },
    {
      ...
      image: "amd.png",
      description:
        "50 多年來，AMD（NASDAQ：AMD）推動創新高效能運算、繪圖及視覺技術，建構遊戲、高臨場感平台與資料中心等重要領域。全球數十億的消費者、世界 500 強企業以及尖端科學研究機構皆仰賴 AMD 的技術來改善生活、工作及娛樂。AMD 員工致力於研發領先的高效能與自行調適產品，不斷突破技術的極限。",
    ...
    },
    {
      ...
      description:
        "帕亞科技目前主力產品為 PAIA 遊戲 AI 競賽平台，我們打造了一個遊戲情境，讓使用者可以上傳各自的 AI 在平台上競賽，也提供積木式的開發工具，讓國中小學生可以輕易使用，學習 AI。\n\n臺科大營建系資訊組以促進資通訊科技於土木營建與防災工程的全生命週期導入與應用為目標，朝向智慧營建及永續土木工程等方向發展。",
      urls: [
        {
          title: "帕亞科技股份有限公司",
  ...
  4: [
    ...
    },
    {
      ...
      image: "line.png",
      description:
        "總部位於日本的 LINE 以「拉近你我的距離」為企業使命，透過多元的行動服務與內容，致力將人們、資訊與社會緊密連結。自 2011 年 6 月以通訊軟體的型態推出，現更推展其多元的全球生態系，並將觸角延伸至人工智慧、金融科技等領域，積極實現「智慧入口」的願景，2021 年 3 月，LINE 與日本規模最大的網路科技集團之一 Z Holdings 正式整併，未來也將持續提供用戶享有最即時、便利的行動生活。",
    ...
    },
    {
      ...
      title: "StarUp 人才孵化器",
      description:
        "StarUp 人才孵化器致力透過建置校園創新創業生態系，培育新時代的未來領袖。\n\n我們透過三大核心業務「社群、育成、投創」聚集積極成長的大學生，透過彼此相互的連結與交流，創造不同的可能性。\n\n我們在疫情中，由創辦人小朱從經營瀕臨倒社的陽明交大創新創業社開始，一步步舉辦活動，匯集「不躺平的年輕人」，現已舉辦 44 場活動、觸及 1500 + 人次，目前 Line 社群人數達 404 人，匯聚超過 40 所系所學生，並且於 2023 開始與海洋大學創客社、大同大學創新創業社組成「BeTheChange 創創聯盟」，共同舉辦活動、共享資源和機會。\n\n除了社群經營外，StarUp 人才孵化器也提供社群中的人才關於創業家與經理人的培訓計畫，進行自我探索、創業思維、專案管理等出社會必備的職場素養課程，並將人才的學習歷程匯集成人才履歷，提供企業參考，幫助認證人才進入企業見習、實習的就業機會，目前已培育 37 位夥伴，成功媒合 22 人次的優秀人才進入職場。\n\n同時我們也將於 2024 年開始，與炙星投創合作，成立學生投創基金，管理 300 萬資金專注投資學生創業團隊，期待挖掘、培跑下一個改變世界的未來領袖。\n\n在今年，我們將成立「台灣創新創業青年領袖協會」，並複製社團拓點模式至不同學校，透過幫助人才進行自我探索，職場素養培訓，以及提供就業與投資機會，協助人才發展個人天賦與熱忱，建立未來世代所需的素養，成為新時代的創新創業領袖。\n\n更多資料歡迎閱覽以下簡報\n\nhttps://reurl.cc/67dXRb",
    },
    {
      number: "21",
      title: "Ruby Taiwan",
      description:
        "Ruby Taiwan 社群成立於 2008 年 10 月，主要是針對 Ruby 程式語言及軟體開發，進行業界的交流及分享，提昇開發人員的技術深度與廣度",
    },
    {
      number: "22",
      title: "Ubuntu-TW",
      description:
        "Ubuntu-TW 成立於 2005 年 6 月，是由數名愛好者發起，以推廣 Ubuntu 為目標的台灣在地社群。除了每年固定舉辦的 Release Party 以及在台灣各開源研討會擺攤展示之外，我們的成員也時常出沒於各大開源社團，而所舉辦的 Release Party 也一直都有其他 Linux 發行版愛好者的參與。除了社群活動之外，我們的成員也有參與 Ubuntu 及其他發行版、開源軟體的 L10N，編篡文件，以及在網上替人解惑。歡迎各路新手高手、舊雨新知，加入 Ubuntu-TW ，跟我們一起推廣 Ubuntu、Linux 及開源文化！",
    },
  ],
};
