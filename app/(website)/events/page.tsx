  ...
  return (
    <TableOfContent>
      ...
      <EventSection
        ...
        backgroundPosition="right"
        content={[
          "第一次參加 SITCON，還沒進入狀況嗎？今年有各式各樣的活動，包含精彩議程、靜態海報展、咖啡廳和攤位等等，還摸不著頭緒要先去哪裡逛逛嗎？還在猶豫該怎麼規劃最充實的時間利用嗎？別擔心！快點進「迷因拼圖」開始遊戲就對啦！",
          "今年的大地遊戲，我們將 SITCON 2024 所有的年會相關活動都融合進了「迷因拼圖」遊戲中！邀請您來一同參與，邊玩邊破解今年所有有趣活動。除此之外，達成指定任務條件後，還可以至紀念品攤位兌換 SITCON 2024 紀念禮品折價券哦～",
          "(注意：紀念品數量有限，趕快開始遊戲吧 > <)",
          // "【點此進入遊戲介面】"
        ]}
      />
