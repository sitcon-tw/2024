    ...
    <div className="flex flex-col lg:flex-row-reverse relative gap-6">
      ...
      <div className="flex flex-col mb-5">
        ...
        <div className="content">
          <Subtitle id="present_notice">議程投稿注意事項</Subtitle>
          ...
          <Subtitle id="poster_notice">海報投稿注意事項</Subtitle>
          <ul className="list-disc ml-4">
            <li>
              除非內容明顯偏離講題、違反 CoC 或不符事實，
              我們不會強制要求作者對研究內容進行修正。
            </li>
            <li>
              投稿格式所有註明「公開」的資訊，其餘將於年會後公開於官方網站（不含「聯絡方式」）；
              「題目」、「摘要」與「主題標籤」以外的資訊將由大會印製與設計，放置於年會現場海報旁。
            </li>
            <li>
            ...
            <li>
              為鼓勵投稿，大會提供投稿者一組報名邀請碼（一稿一組，每人最多一組），
              可優先報名參與本年會，大會方保有最終發放之權力。若您的稿件被接受，
              年會將頒予感謝狀以表彰您的熱情付出與貢獻，並額外提供講者身分入場，
              屆時您可以將年會邀請碼贈與他人使用，邀請親朋好友共襄盛舉。
            </li>
            <li>
              若同一稿件有多個作者，請在「暱稱 / 名字」欄位標示所有講者的稱呼。
              稿件經接受者，無論作者人數，皆只提供一組可轉贈的入場票邀請碼、
              一份參展識別證與一份參展專屬迎賓禮，大會方保有最終發放之權力。
              未佩戴識別證的稿件提供者，僅能在海報展出時，於該時段進入海報所在的展覽區域。
            </li>
          </ul>
          <p>
            若有任何問題或投稿建議，請來信 SITCON 議程組信箱 session@sitcon.org。
